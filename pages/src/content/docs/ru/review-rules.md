...
Фильтр — шестиступенчатый алгоритм в
...
Файлы, прошедшие все шесть проверок, отправляются в LLM декодированным
UTF-8 текстом, а не сырыми байтами. Причина `deleted`
